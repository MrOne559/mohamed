...
const thump = 'https://cdn.discordapp.com/attachments/1026240408155602946/1039313789570514994/image.png';
      ...
      client.guilds.cache.get(client.config.guildId).channels.create({
        ...
        channel.permissionOverwrites.edit(interaction.user, {
          ...
          ViewChannel: true,
            ...
            channel.permissionOverwrites.edit(ticketType.roletomentionId, {
              SendMessages: true,
              AddReactions: true,
              ReadMessageHistory: true,
              AttachFiles: true,
        ...
        .setFooter({
          text: "Arab Night Ticket©" + client.embeds.ticketOpened.footer.text.replace("Arab Night Ticket©", ""), // Please respect the LICENSE :D
        ...
        const body = {
          ...
          content: `<@${interaction.user.id}> ${client.config.pingRoleWhenOpened ? `<@&${ticketType.roletomentionId}>` : ''}`,
        };
